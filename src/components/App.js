...
function App() 
{
	...
	<div id="main">
		...
		<select id="state" value={stateIndex} onChange={handleState}>
			{
		...
		<select id="city" value={cityIndex} onChange={handleCity}>
			{
		...
		<select id="landmark" value={landmarkIndex} onChange={handleLandmark}>
			{
